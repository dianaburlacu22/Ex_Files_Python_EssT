...
class Solution:
    def findDifference(self, nums1: List[int], nums2: List[int]) -> List[List[int]]:
        ...
        # Convert the lists to sets, in order to eliminate duplicate elements
        set1 = set(nums1)
        set2 = set(nums2)

        # Find the distinct numbers between the sets
        distinct_num1 = list(set1 - set2)
        distinct_num2 = list(set2 - set1)
...
class TestSolution(unittest.TestCase):
    ...
    def test_removeDuplicates_example1(self):
        ...
        k = self.solution.findDifference(nums1, nums2)

        self.assertEqual(k, expected, Fore.RED + "Failed on test case 1: Array content mismatch." + Style.RESET_ALL)
    ...
    def test_removeDuplicates_example2(self):
        ...
        self.assertEqual(k, expected, Fore.RED + "Failed on test case 2: Array content mismatch." + Style.RESET_ALL)
